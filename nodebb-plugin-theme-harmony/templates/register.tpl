			...
			<div class="col-12 col-md-5 col-lg-3 px-md-0">
				<div class="register-block">
					<form component="register/local" class="d-flex flex-column gap-3" role="form" action="{config.relative_path}/register" method="post">
						...
						<div class="mb-2 d-flex flex-column gap-2">
    						<label for="isProfessor">[[register:role]]</label>
    						<div>
        						<div class="form-check">
            						<input class="form-check-input" type="checkbox" name="isProfessor" id="isProfessor" aria-required="true" aria-describedby="isProfessor-notify">
